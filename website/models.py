...
class Diagnosis(models.Model):
    ...
    ur4 = models.CharField('Name',max_length=120, blank=True,null=True)
    ul4 = models.CharField('Name', max_length=120, blank=True,null=True)
    lr4 = models.CharField('Name', max_length=120, blank=True,null=True)
    ll4 = models.CharField('Name', max_length=120, blank=True,null=True)
